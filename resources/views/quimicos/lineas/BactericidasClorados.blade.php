					...
					<div class="col-xs-12" id="contenidoPrincipal">
						...
						<div id="itemQuimico" class="col-xs-12">
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >CHEM CLORO DESINFECTANTE CLORADO </dd>

								<dt>Descripcion</dt> 
									<dd>
										<p class="text-justify"> Es un germicida de rápida y potente acción.  Es efectivo a bajas concentraciones por lo que muy resulta económico.</p>
									</dd>
