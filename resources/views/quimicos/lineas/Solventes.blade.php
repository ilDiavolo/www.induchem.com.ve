					...
					<div class="col-xs-12" id="contenidoPrincipal">
						...
						<div id="itemQuimico" class="col-xs-12">
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" > ELECTRO CHEM-300 </dd>

								<dt>Descripción</dt> 
									<dd>
										<p class="text-justify"> Es un desengrasante limpiador y solvente frío de secado rápido, listo para usar. Ofrece una acción limpiadora rápida, desplaza completamente la humedad, es de evaporación inmediata, y no deja residuos sobre las superficies.</p>
									</dd>
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >ELECTRO CHEM-400 </dd>

								<dt>Descripción</dt> 
									<dd>
										<p class="text-justify"> Es un desengrasante limpiador y solvente frío de secado medio, listo para usar. Ofrece una acción limpiadora rápida, desplaza completamente la humedad, es de evaporación inmediata, y no deja residuos sobre las superficies.</p>
									</dd>
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >ELECTRO CHEM-600 </dd>

								<dt>Descripción</dt> 
									<dd>
										<p class="text-justify"> Es un desengrasante limpiador y solvente frío de secado lento, listo para usar. Ofrece una acción limpiadora rápida, desplaza completamente la humedad, es de evaporación inmediata, y no deja residuos sobre las superficies.</p>
									</dd>
