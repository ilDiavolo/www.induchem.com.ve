					...
					<div class="col-xs-12" id="contenidoPrincipal">
						...
						<div id="itemQuimico" class="col-xs-12">
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >CHEM GEL SANITIZER </dd>

								<dt>Descripción</dt> 
									<dd>
										<p class="text-justify"> Gel alcoholado antiséptico para la desinfección de las manos que no requiere ser enjuagado luego de su aplicación.</p>
									</dd>
