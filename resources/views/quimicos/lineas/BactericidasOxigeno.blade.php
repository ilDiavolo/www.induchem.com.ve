					...
					<div class="col-xs-12" id="contenidoPrincipal">
						...
						<div id="itemQuimico" class="col-xs-12">
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >CHEM OXAN </dd>

								<dt>Descripcion</dt> 
									<dd>
										<p class="text-justify"> Es un bactericida para la esterilización química en frío que elimina las bacterias en todo espectro microbiano en la industria de alimentos, quirófanos e instrumentos quirúrgicos.</p>
									</dd>
