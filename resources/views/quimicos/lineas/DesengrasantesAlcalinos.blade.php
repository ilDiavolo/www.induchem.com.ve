					...
					<div class="col-xs-12" id="contenidoPrincipal">
						...
						<div id="itemQuimico" class="col-xs-12">
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >CHEM HALSO </dd>

								<dt>Descripción</dt> 
									<dd>
										<p class="text-justify"> Es un desengrasante neutro, líquido, libre de fosfatos, con alto poder para limpiar y desengrasar.</p>
									</dd>
							...
							<dl class="dl-horizontal">
								<dt>Nombre</dt> 
									<dd style="color: #a94442;" >CHEM ULTRASOL </dd>

								<dt>Descripción</dt> 
									<dd>
										<p class="text-justify"> Desengrasante alcalino biodegradable y  libre de fosfatos con alto poder para limpiar y desengrasar.</p>
									</dd>
