...
<head>
	...
	<link href="{{ asset('css/megaSidebarCodyHouse/reset.css') }}" rel="stylesheet">
	<link href="{{ asset('css/megaSidebarCodyHouse/style.css') }}" rel="stylesheet">

	<script src="{{ asset('js/megaSidebarCodyHouse/modernizr.js') }}" type="text/javascript"></script>	
...
<body>
	...
	<main class="cd-main-content">
		...
		<div class="cd-dropdown-wrapper">				
		<ul class="cd-dropdown-content" style="background-color: white;">
...
<script src="{{ asset('js/megaSidebarCodyHouse/jquery.menu-aim.js') }}" type="text/javascript"></script>	
<script src="{{ asset('js/megaSidebarCodyHouse/main.js') }}" type="text/javascript"></script>	
