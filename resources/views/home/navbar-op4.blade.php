					...
					<ul class="dropdown-menu dropdown-menu-large row">
						<li class="col-sm-3">
							<ul>
								...
								<li><a href="#">Bactericidas</a></li>
								<li class=""><a href="#">Desengrasantes</a></li>
								<li><a href="#">Solventes Dieléctricos </a></li>

								<li class="divider"></li>

								<li class="dropdown-header">Embotelladora</li>

								<li><a href="#">Limpiadores Cáusticos</a></li>
								<li><a href="#">Clear Rendidor</a></li>
								<li><a href="#">Jabones líquidos </a></li>
								<li><a href="#">Bactericida amonio cuaternario</a></li>
								
							</ul>
						</li>
						<li class="col-sm-3">
							<ul>
								<li class="dropdown-header">Cervecería y Refresco</li>
								<li><a href="#">Bactericidas de oxígeno activo</a></li>
								<li><a href="#">Detergentes alcalinos clorados</a></li>
								<li><a href="#">Limpiadores Ácidos</a></li>
								<!-- <li><a href="#">CLEAR CLOR-P</a></li> -->
								<li><a href="#">Lubricantes para Cadenas</a></li>
								<li class="divider"></li>
								<li class="dropdown-header">Azucarero</li>
								<li><a href="#">Abrillantadores Desoxidante </a></li>

							</ul>
						</li>
						<li class="col-sm-3">
							<ul>
								<li class="dropdown-header">Químicos</li>
								<li><a href="#">Detergentes en polvo</a></li>
								<li><a href="#">Lavandería</a></li>
								<li><a href="#">Bactericidas clorados</a></li>
								<li class="divider"></li>
								<li class="dropdown-header">Automotriz</li>
								<li><a href="#">Desengrasantes de cocinas y hornos </a></li>
								<li><a href="#">Desincrustante y Limpiador de porcelana </a></li>
						...
						<li class="col-sm-3">
							<ul>
								...
								<li class="dropdown-header" style="color:#d40b0b;">Materias Primas</li>
								<li><a href="#">ACIDO CLORHIDRICO AL 30% </a></li>
								<li><a href="#">ACIDO NITRICO AL 56% </a></li>							
