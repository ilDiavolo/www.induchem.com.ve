	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 col-xs-12">
				<div class="row">					
					<div class="col-xs-12">
						...
						<hr>
						<iframe class="col-xs-12" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3926.358312789344!2d-67.86835048520378!3d10.232657892691877!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7dac6e086e5497df!2sInduchem%2C+C.A.!5e0!3m2!1ses!2sus!4v1478009044824" width="555" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
			...
			<div class="col-md-7 col-xs-12" >
				...
				<div class="row" style="background-color: whitesmoke; border-radius: 10px; padding: 10px; padding-bottom: 18px; padding-left: 30px;">
			  	...
			  	<div class="row" style="background-color: whitesmoke; border-radius: 10px; padding: 25px;">
					...
					<form action="{{ url('mail') }}" method="POST" role="form" class="form-horizontal" >
						...
						<div class="form-group"> 
						    <div class="col-sm-offset-2 col-sm-10">
						      <button type="submit" class="btn btn-default pull-right" disabled >Enviar</button>
						    </div>
						</div>
