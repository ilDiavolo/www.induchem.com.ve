			...
			<div class="col-xs-3" >
				<div class="row" style="padding: 1em;">
					...
					<div class="col-xs-12" style="background-color: #fff; padding:2em;padding-top: 1em; padding-left: 1em; padding-right: 0; border: 1px solid;box-shadow: 1px 1px 1px;">
						...
						<h4 style="display: inline-block; margin-left: 15px; line-height: 24px;text-shadow: 3px 3px 1px #ddd; font-size: 20px;" > Motores </h4> 
							...
							<div class="row" style="padding: 1em;">
								...
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									...
									<div class="col-xs-12 col-md-6 flex-child">
										...
										<img src="{{ asset('img/motive/prodotti-delphi.jpg') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
							...
							<div class="row" style="padding: 1em;">
								...
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									...
									<div class="col-xs-12 col-md-6 flex-child">
										...
										<img src="{{ asset('img/motive/prodotti-autofrenanti.jpg') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
									<div class="col-xs-12 col-md-6 flex-child" style="margin-top: 20px; margin-bottom: 20px; padding: 0;" >			
							...
							<div class="row" style="padding: 1em;">
								...
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									...
									<div class="col-xs-12 col-md-6 flex-child">
										...
										<img src="{{ asset('img/motive/prodotti-mono.jpg') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
									<div class="col-xs-12 col-md-6 flex-child" style="margin-top: 20px; margin-bottom: 20px; padding: 0;" >			
