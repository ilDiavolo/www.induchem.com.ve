							...
							<div class="row" style="padding: 1em;">
								...
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									...
									<div class="col-xs-12 col-md-6 flex-child">
										...
										<img src="{{ asset('img/actuadores/serie92.png') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
							...
							<div class="row" style="padding: 1em;">
								...
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									...
									<div class="col-xs-12 col-md-6 flex-child">
										...
										<img src="{{ asset('img/actuadores/serie94.png') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
									<div class="col-xs-12 col-md-6 flex-child" style="margin-top: 20px; margin-bottom: 20px; padding: 0;" >			
