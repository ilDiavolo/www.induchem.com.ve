		...
		<div class="row welcome_bar">
			<div class="container">
				<div class="col-sm-7 col-xs-12 bar">
					...
					<div class="bar-title">
						<h1><span>Actuadores</span> </h1>
					</div>
					<div class="breadcrumbs"><a href="{{ url('home') }}">Inicio</a> Actuadores Eléctricos </div>
				</div>
					...
					<div id="itemTermo" class="col-xs-12" style="background-color: #fff; padding: 0;">	
						...
						<div class="col-sm-12 col-md-6" style="background-color: #fff;"> 
							...
							<div class="row" style="padding: 1em;">
								<h3>Actuador Eléctrico serie 92</h3> 
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									 
									<div class="col-xs-12 col-md-6 flex-child">

										<img src="{{ asset('img/PRODUCTOS/actuadores/serie92.png') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
									<div class="col-xs-12 col-md-6 flex-child" style="margin-top: 20px; margin-bottom: 20px; padding: 0;" >			

											<p>	Torque: 400, 700, 1100, 2000 pg/lb. </p>
											<p>	Voltaje: 230/115/24/12 VCA, 24/12 VCD. </p>
											<p>	Acción: Un Cuarto de vuelta. </p>
											<p>	Indicador: Indicación de posición mediante un Faro Visual. Interruptor de límite con contactos para luces indicadoras. Anulación manual desembragable. Alojamiento NEMA 4x/7. Tiempo de ciclo de 10 segundos (400 y 700) Tiempo de Ciclo de 25 segundos (1100 y 2000) </p>
						...
						<div class="col-sm-12 col-md-6" style="background-color: #fff">
							...
							<div class="row" style="padding: 1em;">
								<h3>Actuador Eléctrico serie 94</h3> 
								<div class="col-xs-12 flex-parent" style="background-color: #eee;">
									 
									<div class="col-xs-12 col-md-6 flex-child">

										<img src="{{ asset('img/PRODUCTOS/actuadores/serie94.png') }}" class="img-responsive" style="border-right: 1px solid #9d9d9d;margin-top: 20px; margin-bottom: 20px;padding-right: 1em;">
									</div>
									<div class="col-xs-12 col-md-6 flex-child" style="margin-top: 20px; margin-bottom: 20px; padding: 0;" >			

											<p>	Torque: 150, 300 pg/lb. </p>
											<p>	Voltaje: 230/115/12/24 VCA 12/24 VCD. </p>
											<p>	Acción: Un cuarto de vuelta. </p>
											<p> Indicador: Indicación visual de posición de la válvula. Interruptor de límite con contactos para luces indicadoras. Anulación manual desembragable. Alojamiento NEMA 4X. Ciclo de 5 segundos. </p>
